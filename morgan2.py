...
def generate_speech(text, output_path="output.wav"):
    processor = SpeechT5Processor.from_pretrained("fine_tuned_speecht5")
    model = SpeechT5ForTextToSpeech.from_pretrained("fine_tuned_speecht5")
    ...
    torchaudio.save(output_path, speech.squeeze().cpu(), 22050)
